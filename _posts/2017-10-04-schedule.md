...
<div class="row">
        <div class="12u$(small)">
			...
			<span class="timeline-time">6PM, Robert Lee Alumni Center Jack Poole Hall</span>
                    </div>
                    <div class="timeline-marker"></div>
                    <div class="timeline-content">
                        <h3 class="timeline-title"><b>Final Competition and Reception</b></h3>
                        <p><span class="timeline-desc">Competition - Finals</span> | Dragons' Den style face-off before a panel of judges. Five come in but only three will be rewarded. To buy tickets click <a href="https://tinyurl.com/yczotwco">here</a> (free for students).</p>
                    </div>
                </li>
            </ul>
        </div>
