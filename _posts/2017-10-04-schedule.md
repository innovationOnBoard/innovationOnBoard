            ...
            <ul class="timeline">
                ...
                <li class="timeline-item">
                    ...
                    <div class="timeline-content">
                        ...
                        <p><span class="timeline-desc"> Zack Eberwein, CEO of Embrace Orthopaedics</span> | Three years ago Zack was a young engineering graduate with a dream to build things and change the world. Today, Zack is the CEO of Embrace Orthopaedic, one of the fastest growing UBC companies. Embrace Orthopaedic  is revolutionizing your knee supports by introducing the next generation of athletic wear.  </p>
                    </div>
                </li>
                <li class="timeline-item">
                    <div class="timeline-info">
                    ...
                    <div class="timeline-content">
                        ...
                        <p><span class="timeline-desc"> Mentor and student mixer</span> | Looking for an idea with a side of networking? Come meet your (potential) mentor in the Mentor Mixer! The night will consist of some ice breaker events followed up by a networking session with full catering and drinks provided.</p>
                    </div>
                </li>
                <li class="timeline-item">
                    <div class="timeline-info">
